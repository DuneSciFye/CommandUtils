...
public class CooldownCommandCommand extends Command {
    ...
    public void register() {
        ...
        cooldownMessageHours = this.getConfig().getOptionalString("Commands.CooldownCommand.CooldownMessages.Hours").orElse("&cOn Cooldown for %hours%h, %minutes%m, & %seconds%s.");
        cooldownMessageMinutes = this.getConfig().getOptionalString("Commands.CooldownCommand.CooldownMessages.Minutes").orElse("&cOn Cooldown for %minutes%m & %seconds%s.");
