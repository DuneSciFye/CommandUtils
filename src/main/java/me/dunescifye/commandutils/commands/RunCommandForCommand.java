...
public class RunCommandForCommand extends Command {
    @Override
    public void register() {
        ...
        new CommandAPICommand("runcommandfor")
            .withArguments(ArgumentUtils.manyPlayersArg(), commandSeparatorArg, placeholderSurrounderArg, commandsArg)
            .executes((sender, args) -> {
                final Collection<Player> players = args.getUnchecked(ArgumentUtils.PLAYERS_NAME);
